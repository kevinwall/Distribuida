...
public class CadastroAnimeServer2 
{
	...
	private static void avaliarAnime(Message msg, SocketChannel myClient) 
	{
		...
		try {
			...
			System.out.println("Erro ao enviar o feedback de sincronização para LB");
		}
	}
	...
	private static void cadastrarAnime(Message msg, SocketChannel myClient) 
	{
			...
			{
				System.out.println("Erro no envio do feedback de sincronização");
			}
	}
